    ...
    <div className="bg-gray-50 min-h-screen pt-24 pb-20">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row gap-8">
          ...
          >
            <h1 className="text-3xl font-extrabold text-gray-900 mb-8">Tu carrito de compra</h1>
            ...
            {cart.length === 0 ? (
              ...
              >
                <div className="flex flex-col items-center justify-center py-12">
                  ...
                  <p className="text-gray-500 mb-8 max-w-md">Parece que aún no has añadido ningún producto a tu carrito. Explora nuestra selección de palas y accesorios premium.</p>
                  <Link 
                    to="/palas-de-padel"
                ...
                >
                  {cart.map((item) => (
                    <motion.div 
                      ...
                      className={`bg-white rounded-lg shadow-sm overflow-hidden transition-all ${removingItems.has(item.id) ? 'transform scale-95 opacity-50' : ''}`}
                    >
                      <div className="p-4 md:p-6 flex flex-col md:flex-row md:items-center">
                        ...
                        <div className="flex flex-grow md:w-2/5">
                          ...
                          <div className="ml-4 flex flex-col justify-center">
                            <h3 className="text-base md:text-lg font-medium text-gray-900">{item.nombre}</h3>
                            <p className="mt-1 text-sm text-gray-500">
                              {item.tipo && `${item.tipo}`}
                              {item.marca && ` | ${item.marca}`}
                            </p>
                            {/* Solo visible en móvil */}
                            <p className="md:hidden mt-2 text-sm font-medium text-gray-900">{getItemPrice(item).toFixed(2)} €</p>
                          </div>
                        </div>
                        
                        {/* Precio - Solo Desktop */}
                        <div className="hidden md:block w-1/5 text-center">
                          <span className="text-base font-medium text-gray-900">{getItemPrice(item).toFixed(2)} €</span>
                        </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6 sticky top-24">
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="flex justify-between pt-2">
                    ...
                    <span className="font-bold text-xl">{getCartSubtotal().toFixed(2)} €</span>
                  </div>
                </div>
                ...
                <div className="mt-8 border-t border-gray-200 pt-6">
                  ...
                  <div className="flex items-center mb-4">
                    ...
                    <span className="text-sm font-medium text-gray-700">Devolución en 30 días</span>
                  </div>
                  <div className="flex items-center">
                    ...
                    <span className="text-sm font-medium text-gray-700">Envío gratis a partir de 50€</span>
                  </div>
                </div>
              </div>
            </motion.div>
